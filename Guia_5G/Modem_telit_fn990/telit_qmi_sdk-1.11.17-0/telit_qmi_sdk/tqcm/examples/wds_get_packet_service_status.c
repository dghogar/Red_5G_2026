...
int main(int argc, char **argv)
{
    ...
    uint16_t sdk_error;
    wds_get_packet_service_status_t out = { 0 };
    ...
    ret = tqcm_wds_get_pkt_srvc_status_send(&ctx_wds, &out, &sdk_error, NULL, 0);
    ...
    RLOGI("Packet service status : %d (1: disconnected, 2: connected, 3: suspended, 4: authenticating)",
            out.conn_status);
