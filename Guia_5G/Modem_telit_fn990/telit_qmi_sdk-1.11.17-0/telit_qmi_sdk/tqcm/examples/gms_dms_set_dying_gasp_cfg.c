...
int main(int argc, char **argv)
{
    ...
    dms_dying_gasp_cfg_t input = {
        .sms_destination_number = "123456789",
        .sms_destination_number_len = 9,
        .sms_content = "dying gasp sms content",
        .sms_content_len = 22,
    };
    uint16_t sdk_error;
    ...
    ret = tqcm_gms_dms_set_dying_gasp_config_send(&ctx_gms,
            &input,
            &sdk_error,
            NULL,
            0);
    if (ret != 0) {
        ...
        RLOGI("GMS Set dying gasp config success\n");
    }
