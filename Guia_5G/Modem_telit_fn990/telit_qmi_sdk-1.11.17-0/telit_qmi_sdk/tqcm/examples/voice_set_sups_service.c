...
int main(int argc, char **argv)
{
    ...
    voice_set_sup_service_input_t input = { 0 };
    ...
    input.voice_service = QMI_VOICE_SERVICE_ACTIVATE;
    input.reason = QMI_VOICE_REASON_CALLWAITING;

    ret = tqcm_voice_set_sups_service_send(&ctx_voice,
            &input,
            &out,
            &sdk_error,
            NULL,
