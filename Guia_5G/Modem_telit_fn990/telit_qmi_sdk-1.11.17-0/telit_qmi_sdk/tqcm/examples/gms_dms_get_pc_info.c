...
int main(int argc, char **argv)
{
    ...
    gms_dms_get_pc_info_resp_t output = {0};
    uint16_t sdk_error;
    ...
    ret = tqcm_gms_dms_get_pc_info_send(&ctx_gms,
            &output,
            &sdk_error,
            NULL,
            0);
    ...
    RLOGI("Operating mode: %u", output.operating_mode);
    if (output.lpm_flag_available) {
        RLOGI("LPM flag: %u", output.lpm_flag);
    }
