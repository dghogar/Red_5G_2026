...
int main(int argc, char **argv)
{
    ...
    dms_dying_gasp_stat_t output = {0};
    uint16_t sdk_error;
    ...
    ret = tqcm_gms_dms_get_dying_gasp_stat_send(&ctx_gms,
            &output,
            &sdk_error,
            NULL,
            0);
    ...
    RLOGI("timestamp: %d", output.timestamp);
    RLOGI("sms attempted: %s", output.sms_attempted ? "TRUE" : "FALSE");
