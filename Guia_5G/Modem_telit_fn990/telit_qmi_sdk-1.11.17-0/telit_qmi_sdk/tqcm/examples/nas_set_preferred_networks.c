...
int main(int argc, char **argv)
{
    ...
    uint16_t sdk_error;
    nas_set_system_selection_preference_t input = { 0 };

    input.mode_pref_available = true;
    input.mode_pref = 0b11100;  /* LTE, WCDMA, GSM */
    ...
    ret = tqcm_nas_set_system_selection_preference_send(&ctx_nas, &input, &sdk_error, NULL, 0);
