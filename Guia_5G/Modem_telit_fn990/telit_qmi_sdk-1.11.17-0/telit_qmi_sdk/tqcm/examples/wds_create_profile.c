...
int main(int argc, char **argv)
{
    ...
    /* Uncomment the following line when pco should be requested for IMS profiles */
    /* input.profile_settings.pcscf_addr_using_pco = true; */

    ret = tqcm_wds_create_profile_send(&ctx_wds, &input, &out, &sdk_error, NULL, 0);
