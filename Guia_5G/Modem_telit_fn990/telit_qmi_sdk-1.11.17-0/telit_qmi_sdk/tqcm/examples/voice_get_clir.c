...
int main(int argc, char **argv)
{
    ...
    ret = tqcm_voice_get_clir_send(&ctx_voice,
            &out,
            &sdk_error,
            NULL,
            0);
    ...
    if (out.cl_response_available) {
        RLOGI("active_status %d", out.cl_response.active_status);
        RLOGI("provision_status %d", out.cl_response.provision_status);
    }
