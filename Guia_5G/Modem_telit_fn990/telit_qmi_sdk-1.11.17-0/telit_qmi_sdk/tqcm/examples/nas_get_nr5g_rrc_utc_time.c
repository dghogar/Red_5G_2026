...
int main(int argc, char **argv)
{
    ...
    nas_nr5g_rrc_utc_time_t output = {0};
    uint16_t sdk_error;
    ...
    ret = tqcm_init_client_context(QMI_SVC_NAS,
            &ctx,
            &ctx_nas,
            NULL);
    if (ret != 0) {
    ...
    ret = tqcm_nas_get_nr5g_rrc_utc_time_send(&ctx_nas,
            &output,
            &sdk_error,
            NULL,
            0);
    ...
    print_nas_generic_nr5g_rrc_utc_time(&output);
