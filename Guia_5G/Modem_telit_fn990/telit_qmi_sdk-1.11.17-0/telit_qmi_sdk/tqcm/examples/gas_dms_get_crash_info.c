...
int main(int argc, char **argv)
{
    ...
    gas_dms_get_crash_info_t input = {0};
    ...
    ret = tqcm_gas_dms_get_crash_info_send(&ctx_gas,
            &input,
            &out,
            &sdk_error,
            NULL,
    ...
    RLOGI("crash status %u", out.crash_status);
    if (out.crash_information_available) {
        RLOGI("excep info crash total cnt %u", out.crash_info.excep_info_crash_total_cnt);
    }
