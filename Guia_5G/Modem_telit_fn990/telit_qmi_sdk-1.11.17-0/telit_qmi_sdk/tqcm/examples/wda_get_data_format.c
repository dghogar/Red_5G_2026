...
int main(int argc, char **argv)
{
    ...
    ret = tqcm_wda_get_data_format_send(&ctx_wda,
            &input,
            &out,
            &sdk_error,
            NULL,
    ...
    if (out.dl_data_aggregation_max_datagrams_available) {
        RLOGI("dl_data_aggregation_max_datagrams_available %d",
                out.dl_data_aggregation_max_datagrams_available);
    }

    if (out.dl_data_aggregation_max_size_available) {
        RLOGI("dl_data_aggregation_max_size_available %d", out.dl_data_aggregation_max_size_available);
    }

    if (out.ul_data_aggregation_max_datagrams_available) {
        RLOGI("ul_data_aggregation_max_datagrams_available %d",
                out.ul_data_aggregation_max_datagrams_available);
    }

    if (out.ul_data_aggregation_max_size_available) {
        RLOGI("ul_data_aggregation_max_size_available %d", out.ul_data_aggregation_max_size_available);
    }
