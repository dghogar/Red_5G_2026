...
static int open_hw_data_port_qrtr(tqcm_context_t *ctx)
{
    return req_open_hw_data_port(ctx);
}

void create_dc_ops_qrtr(struct dc_ops_s *dc_ops)
{
    ...
    dc_ops->open_hw_data_port = open_hw_data_port_qrtr;
}
