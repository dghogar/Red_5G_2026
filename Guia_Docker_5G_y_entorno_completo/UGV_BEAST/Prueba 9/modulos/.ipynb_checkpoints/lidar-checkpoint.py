...
class ModuloLidar:
    ...
    def parse_lidar_frame(self, data):
        # 🔧 VOLVEMOS A TU MATEMÁTICA D500 COMPROBADA
        ...
        for i in range(12):
            ...
            # Filtro básico de distancia sin usar intensidad
            if 100 < dist < 2000:
                angulo = (start_angle + i * 0.83333 + self.DESFASE_GRADOS) % 360
                
                # BISTURÍ: Conservamos Frente (270º-360º y 0º-90º), cortamos cámara/mástil
    ...
    def _bucle_escaneo(self):
        print("\n>>> [LIDAR] HILO INICIADO: Buscando puerto libre para D500... <<<\n")
        ...
        while self.lidar_ser is None:
            ...
            for puerto in puertos:
                ...
                try:
                    ...
                    print(f"\n>>> [LIDAR] ✅ CONECTADO AL PUERTO: {puerto} <<<\n")
