...
from openapi_server.models.transport_dependency import TransportDependency  # noqa: E501
...
class ServiceDependency(Model):
    ...
    def __init__(self, ser_name=None, ser_category=None, version=None, ser_transport_dependencies=None, requested_permissions=None):  # noqa: E501
    ...
    def ser_name(self) -> str:
        ...
        The name of the service, for example, RNIS, LocationService, AMS, etc.  # noqa: E501
    ...
    def ser_transport_dependencies(self) -> List[TransportDependency]:
        ...
        Indicates transport and serialization format dependencies of consuming the service. Defaults to REST + JSON if absent. See note.  # noqa: E501
    ...
    def ser_transport_dependencies(self, ser_transport_dependencies: List[TransportDependency]):
        ...
        if ser_transport_dependencies is not None and len(ser_transport_dependencies) < 0:
            raise ValueError("Invalid value for `ser_transport_dependencies`, number of items must be greater than or equal to `0`")  # noqa: E501
