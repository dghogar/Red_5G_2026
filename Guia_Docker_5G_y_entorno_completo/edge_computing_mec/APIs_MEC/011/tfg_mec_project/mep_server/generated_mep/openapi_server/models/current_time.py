...
class CurrentTime(Model):
    ...
    def __init__(self, seconds=None, nano_seconds=None, time_source_status=None):  # noqa: E501
        """CurrentTime - a model defined in OpenAPI
    ...
    def time_source_status(self) -> str:
        ...
        Platform Time Source status with the following permitted values: TRACEABLE - time source is locked to the UTC time source NONTRACEABLE - time source is not locked to the UTC time source  # noqa: E501
