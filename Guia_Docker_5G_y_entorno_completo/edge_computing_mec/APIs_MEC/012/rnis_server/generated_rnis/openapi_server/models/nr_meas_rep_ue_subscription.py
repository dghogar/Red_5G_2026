...
class NrMeasRepUeSubscription(Model):
    ...
    def __init__(self, subscription_type=None, callback_reference=None, request_test_notification=None, websock_notif_config=None, links=None, filter_criteria_nr_mrs=None, expiry_deadline=None):  # noqa: E501
        """NrMeasRepUeSubscription - a model defined in OpenAPI
