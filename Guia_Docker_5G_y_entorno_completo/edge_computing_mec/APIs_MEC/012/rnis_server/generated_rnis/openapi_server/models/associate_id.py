...
class AssociateId(Model):
    ...
    def __init__(self, type=None, value=None):  # noqa: E501
        """AssociateId - a model defined in OpenAPI
    ...
    def type(self) -> int:
        ...
        Numeric value (0-255) corresponding to specified type of identifier as following: 0 = reserved. 1= UE_IPv4_ADDRESS. 2 = UE_IPV6_ADDRESS. 3 = NATED_IP_ADDRESS. 4 = GTP_TEID.  # noqa: E501
